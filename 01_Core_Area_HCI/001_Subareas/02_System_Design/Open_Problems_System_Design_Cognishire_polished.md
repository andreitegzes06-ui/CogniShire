...
This page does not repeat [[Theory]], [[Design]], or [[Experiment]]. Those chambers explain the principles, construction work, and testing methods of the Interface Forge. This chamber asks where those principles break, where design decisions become unstable, and where evidence is still incomplete.
...
This frontier connects to [[Experiment]] and to [[01_Core_Area_HCI/001_Subareas/03_Evaluating_the_Design/Overview|Observation Chamber]]. A design artifact needs evidence that matches its claim.
...
This chamber connects to [[Theory]] because open problems expose limits in interface principles. It connects to [[Design]] because those problems become design decisions. It connects to [[Experiment]] because every unresolved claim needs evidence. It connects to [[Connections]] because System Design crosses software engineering, visual communication, industrial design, graphics, ubiquitous computing, and human-centred systems. It connects outward to [[Local and Global]] because many design problems appear only when systems travel across contexts.
