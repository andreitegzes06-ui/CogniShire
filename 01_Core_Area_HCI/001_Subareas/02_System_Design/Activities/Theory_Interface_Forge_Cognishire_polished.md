...
In this project, navigation theory matters because the vault itself is an interface. [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Overview|Mind Library]], [[01_Core_Area_HCI/001_Subareas/02_System_Design/Overview|Interface Forge]], [[01_Core_Area_HCI/001_Subareas/03_Evaluating_the_Design/Overview|Observation Chamber]], [[01_Core_Area_HCI/001_Subareas/04_Accessibility_and_Accountability/Overview|Inclusive Gate]], and [[01_Core_Area_HCI/001_Subareas/05_Human_AI_Interaction/Overview|Oracle Engine]] should behave like meaningful regions, not random folders.
...
This loop connects the Interface Forge to the [[01_Core_Area_HCI/001_Subareas/03_Evaluating_the_Design/Overview|Observation Chamber]], where prototypes are tested, and to the [[01_Core_Area_HCI/001_Subareas/04_Accessibility_and_Accountability/Overview|Inclusive Gate]], where interface theory is checked against accessibility and ethics.
