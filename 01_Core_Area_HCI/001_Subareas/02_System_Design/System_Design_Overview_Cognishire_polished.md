...
The [[../01_Mind_Library/Overview|Mind Library]] explains users. The Interface Forge turns that understanding into interface form. The [[../03_Observation_Chamber/Overview|Observation Chamber]] tests whether the form works. The [[../04_Inclusive_Gate/Overview|Inclusive Gate]] checks access, ethics, and accountability. The [[../05_Oracle_Engine/Overview|Oracle Engine]] extends the map toward intelligent and AI-mediated systems.
...
|---|---|
| [[../01_Mind_Library/Overview|Mind Library]] | Supplies user concepts: mental models, memory, cognitive load, trust, accessibility needs |
| [[../03_Observation_Chamber/Overview|Observation Chamber]] | Supplies methods for testing and evidence |
| [[../04_Inclusive_Gate/Overview|Inclusive Gate]] | Supplies accessibility, ethics, and accountability constraints |
| [[../05_Oracle_Engine/Overview|Oracle Engine]] | Supplies human-AI interaction, uncertainty, automation, and control problems |
