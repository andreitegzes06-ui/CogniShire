...
This page connects to [[Theory]] because local-global evaluation is a validity problem. It connects to [[Design]] because protocols must define local participants, tasks, and tools. It connects to [[Experiment]] because the test must actually be run. It connects to [[Important People]] because local UVT routes and global evaluation researchers both matter. It connects to [[Important Venues]] because local research routes and global evaluation venues both define where the field is learned and reviewed.
