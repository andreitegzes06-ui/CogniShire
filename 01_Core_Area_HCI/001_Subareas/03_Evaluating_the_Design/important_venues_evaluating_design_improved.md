...
This page connects to [[Theory]] because venues shape what counts as evidence. It connects to [[Design]] because protocols depend on method traditions. It connects to [[Experiment]] because studies are published and criticised through these communities. It connects to [[Connections]] because evaluation draws from statistics, psychology, accessibility, software engineering, human factors, ethics, and analytics. It connects to [[Important People]] because researchers and practitioners work through these venues.
