...
```mermaid
flowchart TB
    A((Cognishire Local-Global Route))
    ...
    B --> B1[Support, education, Informatics]
    C --> C1[RoCHI, USV, evaluation]
    D --> D1[WCAG, ASSETS, WAI]
    E --> E1[Fix vault and sources]
    F --> F1[Student/professor check]
...
This page connects to [[Theory]] because local and global routes shape the meaning of accessibility. It connects to [[Design]] because these routes become design requirements. It connects to [[Experiment]] because local and national evidence must be tested. It connects to [[Connections]] because accessibility crosses education, software engineering, disability studies, policy, AI, and HCI. It connects to [[Important People]] because people routes must be represented carefully.
