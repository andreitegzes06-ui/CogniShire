...
- **Agents, chatbots, robots, assistants:** start with: HAI, HRI, IVA, ICMI; then check: ACL, EMNLP, CHI
...
- **Local UVT grounding:** start with: UVT Faculty of Informatics, CSAI, DTSE, TRAIN; then check: UVT AI/ML routes and seminars
...
- **How should an AI answer be displayed?:** best first route: IUI, CHI; good second route: HAX, PAIR
- **How should the system explain uncertainty?:** best first route: IUI, CHI, VIS; good second route: FAccT, TiiS
- **How do users calibrate trust?:** best first route: CHI, IUI, TiiS; good second route: FAccT, AIES
- **How should human oversight work?:** best first route: EU AI Act, NIST AI RMF; good second route: CHI, HAX
- **How does AI affect work?:** best first route: CSCW, CHIWORK; good second route: CHI, ICSE
- **How do agents or assistants interact with users?:** best first route: HAI, HRI, IVA; good second route: CHI, ACL
- **How can AI support accessibility?:** best first route: ASSETS, Web4All; good second route: CHI, IUI
- **How does AI affect learning?:** best first route: SIGCSE, AIED, Learning at Scale; good second route: CHI, LAK
- **How should a local UVT study be grounded?:** best first route: UVT CSAI, DTSE, AI/ML routes; good second route: RoCHI, CHI, IUI
