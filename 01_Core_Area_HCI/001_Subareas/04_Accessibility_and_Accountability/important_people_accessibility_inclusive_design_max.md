...
This page connects to [[Theory]] because people define the concepts and debates. It connects to [[Design]] because their work informs components, methods, and tools. It connects to [[Experiment]] because accessibility claims need evidence. It connects to [[Connections]] because accessibility depends on disability studies, software engineering, law, AI, education, and policy. It connects to [[Important Venues]] because these people publish through accessibility and HCI communities.
