...
This page connects to [[Theory]] because open problems expose the limits of accessibility concepts. It connects to [[Design]] because barriers must become design repairs. It connects to [[Experiment]] because each frontier needs evidence. It connects to [[Connections]] because accessibility crosses education, software engineering, disability studies, AI, law, and policy. It connects to [[Local and Global]] because every accessibility claim has a UVT, Romanian, and global scale.
