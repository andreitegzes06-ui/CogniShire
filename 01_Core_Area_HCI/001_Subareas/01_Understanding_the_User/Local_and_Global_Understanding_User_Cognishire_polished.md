...
This page connects to [[Theory]] because local observations need concepts. It connects to [[Design]] because user findings shape the map’s structure. It connects to [[Experiment]] because local user tests produce evidence. It connects to [[Important People]] because the local people route must include UVT as well as global HCI researchers. It connects to [[Important Venues]] because local seminars and global HCI venues both matter.
