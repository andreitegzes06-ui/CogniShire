...
Theory connects directly to [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Activities/Design]], because design turns concepts into interface form. It also connects to [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Activities/Experiment]], because experiments test whether those concepts explain real user behaviour.
...
Microsoft's Human-AI Interaction Guidelines organise design guidance around initial interaction, regular interaction, situations where the AI system is wrong, and system behaviour over time. Google’s People + AI Guidebook gives related practical guidance for human-centred AI products. In the Map of HCI, this topic connects the Mind Library to [[01_Core_Area_HCI/001_Subareas/05_Human_AI_Interaction/Overview|Human-AI Interaction]] and to [[01_Core_Area_HCI/001_Subareas/01_Mind_Library/Open Problems]].
...
> If theory says that users rely on recognition rather than recall, then [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Activities/Design]] should make important options visible. [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Activities/Experiment]] should then test whether users find those options faster and with fewer errors.
...
|---|---|---|---|
| Mental model | Information architecture and conceptual clarity | Wrong path, hesitation, repeated search | [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Activities/Design]] |
| Affordance and signifier | Action visibility | Missed control, false click | [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Activities/Design]] |
| Feedback | System status and recovery | Repeated action, uncertainty, repair time | [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Activities/Experiment]] |
| Cognitive load | Task complexity and information density | Long time, scanning, self-correction | [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Activities/Experiment]] |
| Accessibility | Inclusive perception and operation | Keyboard failure, contrast issue, screen reader problem | [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Local and Global]] |
...
The rest of the library depends on this archive. [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Activities/Design]] draws from it, [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Activities/Experiment]] tests it, [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Connections]] carries it into other disciplines, and [[01_Core_Area_HCI/001_Subareas/01_Mind_Library/Open Problems]] revises it when emerging systems create new forms of interaction.
...
This chamber connects to [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Overview]] because it explains the conceptual purpose of the Mind Library. It connects to [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Activities/Design]] because theory becomes interface form. It connects to [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Activities/Experiment]] because theory becomes evidence interpretation. It connects to [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Connections]] because HCI theory travels across cognition, design, computing, accessibility, ethics, and AI. It connects to [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Important people]] because many theoretical ideas come from named scholars and research traditions. It connects to [[01_Core_Area_HCI/001_Subareas/01_Mind_Library/Open Problems]] because new technologies continually stress and revise existing theory.
