...
This entrance page links the major routes through the chamber. [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Activities/Theory|Theory]] explains concepts such as perception, mental models, affordances, feedback, memory, and cognitive load. [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Activities/Design|Design]] turns user understanding into labels, flows, constraints, feedback, and prototypes. [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Activities/Experiment|Experiment]] tests whether claims about users survive contact with evidence. [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Connections]] shows how user understanding connects psychology, computing, design, accessibility, ethics, and AI.

The chamber also needs scholarly orientation. [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Important people]] points to researchers and academic routes. [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Important Venues]] shows where HCI research is published, reviewed, and standardised. [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Local and Global]] explains why user experience depends on place, language, culture, infrastructure, and institution. [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Open Problems]] marks the parts of user understanding that remain unsettled.
...
This is why the Mind Library connects to the other rooms of the map. The [[01_Core_Area_HCI/001_Subareas/02_System_Design/Overview|Interface Forge]] needs user understanding because visual and interactive form must support perception and action. The [[01_Core_Area_HCI/001_Subareas/03_Evaluating_the_Design/Overview|Observation Chamber]] needs it because evidence must be interpreted through human behaviour. The [[01_Core_Area_HCI/001_Subareas/04_Accessibility_and_Accountability/Overview|Inclusive Gate]] depends on it because sensory, cognitive, and motor diversity are part of user understanding. The [[01_Core_Area_HCI/001_Subareas/05_Human_AI_Interaction/Overview|Oracle Engine]] needs it because AI systems create new problems of explanation, trust, control, and error.
...
|---|---|---|
| Conceptual archive | [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Activities/Theory]] | Explains mental models, affordances, feedback, cognition, accessibility, and human-AI concepts. |
| Form-making chamber | [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Activities/Design]] | Turns user understanding into labels, flows, feedback, constraints, and prototypes. |
| Evidence chamber | [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Activities/Experiment]] | Tests usability, comprehension, accessibility, performance, and interpretation. |
| Bridge map | [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Connections]] | Connects cognition with design, computing, AI, ethics, accessibility, and society. |
| Scholar roadmap | [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Important people]] | Locates researchers, labs, and study routes related to user understanding. |
| Academic atlas | [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Important Venues]] | Shows conferences, journals, standards, and organisations where HCI knowledge is developed. |
| Scale map | [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Local and Global]] | Compares local contexts with global systems and standards. |
| Frontier map | [[01_Core_Area_HCI/001_Subareas/01_Understanding_the_User/Open Problems]] | Identifies unresolved problems in user modelling, accessibility, AI, evidence, and context. |
...
> [!tip] Return Path
> [[../The five rooms of HCI|Return to the Five Rooms of HCI]]  
