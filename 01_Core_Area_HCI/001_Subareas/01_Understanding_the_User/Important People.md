...
This route focuses on make interaction visible: prototypes, design tools, interface techniques, mobile interfaces, and human-centred AI products.
...
- **Why it is useful:** For studying study HCI design, design tools, and human-centred AI in a research university context.
- **How to study it:** Study Stanford-style HCI design courses, read work on design tools and behaviour-change technologies, then follow Stanford HAI work on human-centred AI.
- **Before emailing:** Prepare a precise topic such as “human-centred AI design”, “mobile HCI”, or “interface design tools”. Mention one paper, course, or research route.
...
- **Why it is useful:** For studying connect HCI, design education, prototyping, and creative tools.
- **How to study it:** Start with interaction design and prototyping methods. Then examine how design tools support creative work and learning.
- **Before emailing:** Show a specific interest in design research or HCI education. A small prototype or study idea helps.
...
- **Why it is useful:** For studying concrete interface systems, input methods, design tools, and emerging interaction techniques.
- **How to study it:** Study UI software, input techniques, mixed reality interaction, and research papers from CHI and UIST.
...
This route focuses on disability, assistive technology, inclusive design, accessible computing, and systems that adapt to human diversity.
...
- **Why it is useful:** Useful for students who want rigorous accessibility research and evidence-based HCI methods.
- **How to study it:** Study ability-based design, accessible input, CHI papers, ASSETS papers, UW CREATE, and the DUB group.
...
- **Why it is useful:** For studying study technologies that adapt to different bodies, senses, abilities, and contexts.
- **How to study it:** Study accessibility, inclusive design, mobile/wearable HCI, assistive technology evaluation, and human-centred AI for accessibility.
- **Before emailing:** Read one recent paper or lab study from the Inclusive Design Lab or CREATE.
...
- **Why it is useful:** For studying personalization, universal usability, older adults, accessibility, and collaborative systems.
- **How to study it:** Study personalized UI, adaptive and adaptable interfaces, universal usability, assistive technology, and qualitative plus quantitative evaluation.
...
- **Why it is useful:** For studying connect adaptive interfaces, accessibility, intelligent systems, and human-centred AI methods.
- **How to study it:** Study personalized UI, accessibility, human-AI interaction, LabintheWild-style behavioural studies, and intelligent interactive systems.
...
- **Why it is useful:** For studying education, equity, programming tools, learning, and inclusive participation.
- **How to study it:** Read her lab page, computing education papers, and writing on equity in computing.
...
- **Why it is useful:** Useful for students who want HCI to be mathematically, computationally, and experimentally grounded.
- **How to study it:** Study computational interaction, cognitive modelling, optimisation, human performance, and interactive AI.
...
- **Why it is useful:** For studying ask what interaction means and how HCI should define its core concepts.
- **How to study it:** Read HCI theory papers, empirical HCI methods, and work from the University of Copenhagen HCI group.
...
- **Why it is useful:** For studying ubiquitous computing, future interfaces, and interaction beyond standard desktop or mobile screens.
- **How to study it:** Study ubiquitous computing, HCI evaluation, intelligent interfaces, tangible interaction, and novel interaction techniques.
...
- **Why it is useful:** For studying build tools that help people understand, communicate, and analyse data.
- **How to study it:** Learn visualization grammar, data interaction, visual analytics, D3, Vega-Lite, and human-centred data tools.
- **Before emailing:** Build a small visualization study and connect it to one system, paper, or lab theme.
...
- **Why it is useful:** For studying study input devices, large displays, gesture, and embodied interaction.
- **How to study it:** Study interaction techniques, input devices, pointing, gestures, large-display HCI, and mixed reality systems.
...
This route focuses on move beyond screens into tangible interfaces, fabrication, shape-changing interfaces, embodied interaction, and physical-digital systems.
...
- **Why it is useful:** For studying understand tangible interaction and post-GUI visions of HCI.
- **How to study it:** Study Tangible Bits, Radical Atoms, TEI papers, shape-changing interfaces, and Tangible Media projects.
...
- **Why it is useful:** For studying fabrication, physical computing, devices, and post-screen interaction.
- **How to study it:** Study HPI HCI projects, fabrication papers, TEI/UIST/CHI work, haptics, and physical prototyping.
...
- **Why it is useful:** Useful for students who want a broad interdisciplinary route into HCI, interaction design, human-centred AI, and human-data interaction.
- **How to study it:** Study UCLIC programmes, interaction design textbooks, human-centred AI, human-data interaction, and interdisciplinary HCI projects.
...
The roadmap becomes useful only when it produces an action plan. A student should not try to contact everyone. The better approach is to select a route, study the field, build a small study, then contact a professor only when the connection is specific.
...
> Dear Professor [Name],  
> I am a first-year student interested in HCI, especially [specific topic]. I read your work/page on [specific paper or lab page], and I am trying to understand how to prepare for research in this area. I am currently building a small study on [topic], where I am testing [method or idea].  
>  
...
> [!abstract]
> [[Local and Global|Next: Local and Global]]
