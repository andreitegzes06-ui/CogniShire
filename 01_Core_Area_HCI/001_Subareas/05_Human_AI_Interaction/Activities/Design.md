...
- **Recommender:** main design risk: User may not know why options are ranked (support: Explanation, alternatives, user preference controls)
- **Classifier:** main design risk: User may treat labels as objective facts (support: Confidence, appeal, examples, human review)
- **Predictor:** main design risk: User may overtrust uncertain forecasts (support: Uncertainty, range, history, verification)
- **Assistant:** main design risk: User may misunderstand what help is available (support: Capability guidance, examples, correction path)
- **Agent:** main design risk: User may not know what actions the AI can take (support: Permissions, step preview, stop, undo, audit log)
...
- **Factor explanation:** useful for: Showing important inputs; risk: Can oversimplify model behaviour
- **Example explanation:** useful for: Showing similar cases; risk: Similarity can mislead
- **Counterfactual explanation:** useful for: Showing what would change the output; risk: May imply false control
- **Natural-language explanation:** useful for: Easy to read; risk: Can sound plausible without being accurate
- **Visual explanation:** useful for: Pattern recognition; risk: Can increase cognitive load
...
- **Capability card:** problem solved: Users do not know what AI can do; example use: AI tutor, writing assistant
- **Limits statement:** problem solved: Users overestimate AI; example use: Medical, legal, academic, technical domains
- **Source panel:** problem solved: Users need factual verification; example use: Search, summarisation, research assistant
- **Confidence explanation:** problem solved: Users need uncertainty guidance; example use: Prediction, classification
- **Alternative suggestions:** problem solved: One answer creates tunnel vision; example use: Recommendations, planning
- **Human review gate:** problem solved: Output is high-stakes; example use: Hiring, grading, health, finance
- **Accept / revise / reject:** problem solved: User remains final author; example use: Writing, design, coding
- **Undo and rollback:** problem solved: AI may act incorrectly; example use: Agentic tools
- **Permission screen:** problem solved: AI accesses files or tools; example use: Agents, automation
- **Error report button:** problem solved: User discovers wrong output; example use: Any AI product
- **Interaction log:** problem solved: Need traceability; example use: Professional or academic work
- **Plain-language mode:** problem solved: Output is too complex; example use: Education, accessibility
- **Accessibility mode:** problem solved: Users need format control; example use: AI summaries, diagrams, captions

## Example design: AI academic assistant

This example is generic. It is not tied to one study.
...
- **AI product designer:** design skills to build: Capability boundaries, prompts, output cards, controls; portfolio evidence: Figma prototype of an AI feature with risk-aware states
- **UX researcher for AI:** design skills to build: Trust, verification, usability, explanation studies; portfolio evidence: User study testing trust or source checking
- **Human-AI interaction researcher:** design skills to build: Mental models, oversight, uncertainty, human control; portfolio evidence: Research question plus prototype and evaluation protocol
- **Responsible AI designer:** design skills to build: Risk, fairness, privacy, accountability, oversight; portfolio evidence: Risk log, data boundary design, audit trail
- **Accessibility specialist:** design skills to build: AI accessibility, screen reader support, alt text quality; portfolio evidence: Accessibility evaluation of AI-generated content
- **AI education designer:** design skills to build: AI literacy, learning scaffolds, reflection; portfolio evidence: Student AI workflow with verification and reflection
- **Explainable AI designer:** design skills to build: Explanation, evidence, uncertainty, alternatives; portfolio evidence: Comparison of explanation styles
- **Agentic AI designer:** design skills to build: Permissions, preview, stop, undo, action logs; portfolio evidence: Agent workflow prototype with control states
