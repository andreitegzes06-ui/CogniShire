...
```mermaid
flowchart TB
    A((Oracle People Roadmap))

    A --> B[Local UVT Routes]
    A --> C[Romanian HCI + AI Routes]
    A --> D[Human-Centered AI]
    A --> E[Human-AI Guidelines]
    A --> F[Human-AI Collaboration]
    A --> G[Explainable AI]
    A --> H[Responsible AI]
    A --> I[AI Accessibility]
    A --> J[AI Literacy]

    B --> B1[CSAI, DTSE, AI/ML, XAI, recommender systems]
    C --> C1[RoCHI, USV/MintViz, ABILITIES]
    D --> D1[Shneiderman, Yang, Wang]
    E --> E1[Amershi, Kamar, Inkpen, Horvitz]
    F --> F1[Wang, Inkpen, Weisz, Muller]
    G --> G1[Liao, Ehsan, Varshney]
    H --> H1[Gebru, Buolamwini, Mitchell, Solaiman]
    I --> I1[Morris, Vatavu, Schipor, ASSETS]
    J --> J1[Yang, PAIR, Stanford HAI]
...
```mermaid
flowchart TB
    A((Local UVT Oracle Routes))

    A --> B[CSAI]
    A --> C[DTSE]
    A --> D[AI + ML Research]
    A --> E[XAI]
    A --> F[Recommender Systems]
    A --> G[e-Health + Medical Informatics]
    A --> H[Software + Workflow Systems]

    B --> B1[AI, ML, data, intelligent systems]
    C --> C1[Software, web, cloud, workflows]
    D --> D1[Prediction, learning, model behaviour]
    E --> E1[Transparency and model interpretation]
    F --> F1[Ranking, personalisation, user models]
    G --> G1[High-stakes human context]
    H --> H1[Deployment, logs, versions, reliability]
...
flowchart TB
    ...
    A --> G[Gabriel Iuhasz]
    A --> H[Mădălina Erașcu]
    A --> I[Workflow + Web Routes]

    B --> B1[ML, signal/image, XAI route]
    C --> C1[Machine learning and XAI]
    D --> D1[ML, data mining, optimisation]
    E --> E1[Recommender systems]
    F --> F1[Multi-agent systems and e-health]
    G --> G1[Multi-agent systems, ML, cloud]
    H --> H1[Formal verification and reliable systems]
    I --> I1[Web, workflows, ontologies]
...
```mermaid
flowchart TB
    A((Romanian Oracle Routes))

    A --> B[Radu-Daniel Vatavu]
    A --> C[Ovidiu-Andrei Schipor]
    A --> D[ABILITIES Team]
    A --> E[RoCHI Community]
    A --> F[Romanian Accessibility Evaluation]
    A --> G[Romanian Language Context]

    B --> B1[HCI, XR, accessible computing]
    C --> C1[Assistive tech and speech systems]
    D --> D1[Generative AI for accessibility]
    E --> E1[National HCI route]
    F --> F1[Web/accessibility evaluation]
    G --> G1[Terminology and localisation]
...
flowchart TB
    ...
    B --> B1[Human control and automation]
    C --> C1[Human-AI interaction design]
    D --> D1[Human-AI collaboration systems]
    E --> E1[Institutional HAI route]
...
flowchart TB
    ...
    B --> B1[18 guidelines and HAX]
    C --> C1[Reliable AI collaboration]
    D --> D1[Human + AI experiences]
    E --> E1[AI, uncertainty, decisions]
    F --> F1[People + AI Guidebook]
...
flowchart TB
    ...
    B --> B1[Transparency and oversight]
    C --> C1[Human-centered XAI]
    D --> D1[Trustworthy AI]
    E --> E1[Generative AI and HCI]
    F --> F1[Socially situated AI]
...
```mermaid
flowchart TB
    A((Responsible AI Route))

    A --> B[Timnit Gebru]
    A --> C[Joy Buolamwini]
    A --> D[Margaret Mitchell]
    A --> E[Irene Solaiman]
    A --> F[NIST / EU AI Act]

    B --> B1[AI harms, labour, power]
    C --> C1[Algorithmic bias and audit]
    D --> D1[Documentation and ethics]
    E --> E1[Policy and release decisions]
    F --> F1[Risk management and oversight]
...
This route connects the Oracle Engine to the [[../04_Accessibility_and_Inclusive_Design/Overview|Inclusive Gate]]. AI can support access, but it can also automate barriers.

```mermaid
flowchart TB
    A((AI Accessibility Route))

    A --> B[Meredith Ringel Morris]
    A --> C[Radu-Daniel Vatavu]
    A --> D[Ovidiu-Andrei Schipor]
    A --> E[ABILITIES]
    A --> F[ASSETS Community]

    B --> B1[AI accessibility and HAI]
    C --> C1[Accessible computing and XR]
    D --> D1[Assistive technology]
    E --> E1[Generative AI for access]
    F --> F1[Accessible computing research]
...
```mermaid
flowchart TB
    A((Choose a People Route))

    A --> B[AI interface behaviour]
    A --> C[Trust and oversight]
    A --> D[Explanations]
    A --> E[Collaboration]
    A --> F[Responsible AI]
    A --> G[Accessibility]
    ...
    B --> B1[Amershi / HAX / PAIR]
    C --> C1[Kamar / Liao / Shneiderman]
    D --> D1[Liao / Ehsan / Varshney]
    E --> E1[Wang / Inkpen / Weisz / Muller]
    F --> F1[Gebru / Buolamwini / Mitchell / Solaiman]
    G --> G1[Morris / Vatavu / Schipor / ASSETS]
    H --> H1[CSAI / DTSE / UVT AI-ML routes]
    I --> I1[RoCHI / USV / ABILITIES]
...
```mermaid
flowchart LR
    A[Choose exact question] --> B[Read official profile]
    B --> C[Read one paper or project]
    C --> D[Write one precise question]
    D --> E[Use official contact route]
    E --> F[Wait respectfully]
    F --> G[Continue from public materials]
...
flowchart TB
    ...
    B --> B1[CSAI, DTSE, XAI, recommender systems]
    C --> C1[RoCHI, Vatavu, Schipor, ABILITIES]
    D --> D1[Amershi, Yang, Shneiderman, PAIR]
    E --> E1[Liao, Ehsan, Varshney]
    F --> F1[Gebru, Buolamwini, Mitchell, Solaiman]
    G --> G1[Morris, ASSETS, ABILITIES]
...
This page connects to [[Theory]] because these routes define the concepts behind Human-AI Interaction. It connects to [[Design]] because their work becomes interface patterns. It connects to [[Experiment]] because their methods help test trust, understanding, explanation, verification, and oversight. It connects to [[Connections]] because each person belongs to several fields at once. It connects to [[Local and Global]] because UVT, Romania, and global HCI must all remain visible.
