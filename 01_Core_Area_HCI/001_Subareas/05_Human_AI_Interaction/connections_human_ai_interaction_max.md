...
The Oracle Engine connects directly to the [[../04_Accessibility_and_Inclusive_Design/Overview|Inclusive Gate]]. AI can support access, but it can also create new barriers.
...
This page connects to [[Theory]] because each bridge explains a concept behind Human-AI Interaction. It connects to [[Design]] because each bridge becomes an interface requirement. It connects to [[Experiment]] because each bridge needs evidence. It connects to [[../Overview|Overview]] because the Oracle Engine coordinates the Human-AI room.
