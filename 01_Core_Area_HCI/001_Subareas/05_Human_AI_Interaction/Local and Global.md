...
This page connects to [[Activities/Theory]] because local and global routes explain the concepts behind Human-AI Interaction. It connects to [[Activities/Design]] because these routes become interface patterns. It connects to [[Activities/Experiment]] because claims need local evidence and global methods. It connects to [[Connections]] because Human-AI Interaction crosses AI, HCI, software, ethics, accessibility, education, and security. It connects to [[Important People]] and [[Important Venues]] because the local, Romanian, and global maps must be visible together.
